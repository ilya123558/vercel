...
export const ProfileRatingInfo = () => {
    ...
    <div className="w-full h-[30vh] flex items-center justify-center">
      <div className="">
        ...
        <motion.div {...animationLeft}>
          <h5 className="fs-13 font-normal text-center mt-[1vw]">{user.fullName}</h5>
          <p className="text-center fs-17 font-bold">#{formatCount(43759)}</p>
        </motion.div>
      </div>
    </div>
  );
